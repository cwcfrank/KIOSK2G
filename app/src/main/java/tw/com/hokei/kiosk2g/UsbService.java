...
public class UsbService extends Service {
     ...
     */
    private final int VENDOR_ID1 = 1027;
    private final int PROD_ID1 = 24577;

    private final int VENDOR_ID2 = 1133;
    private final int PROD_ID2 = 49271;
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                if (deviceVID == VENDOR_ID1 && devicePID == PROD_ID1) {
